...
//		MethodInfo MakeGenericMethod (TypeSpec[] targs);
	...
	public sealed class MethodSpec : MemberSpec, IParametersMember
	{
	    ...
	    private readonly bool _isRoleMethod;
	    TypeSpec returnType;
		...
		public MethodSpec (MemberKind kind, TypeSpec declaringType, IMemberDefinition details, TypeSpec returnType,
			MethodBase info, AParametersCollection parameters, Modifiers modifiers,bool isRole)
			: base (kind, declaringType, details, modifiers)
		{
			this.metaInfo = info;
			this.parameters = parameters;
            _isRoleMethod = isRole;
	    ...
	    public bool IsRoleMethod{
	        get { return _isRoleMethod; }
	    }
...
//				return ginstance;
	...
	public abstract class MethodOrOperator : MethodCore, IMethodData
	{
		...
		protected MethodOrOperator (DeclSpace parent, GenericMethod generic, FullNamedExpression type, Modifiers mod,
                ...
                Attributes attrs, ParametersCompiled parameters, bool isRoleMethod)
			: base (parent, generic, type, mod, allowed_mod, name,
					attrs, parameters){
                        _isRoleMethod = isRoleMethod;
		}

        protected bool IsRoleMethod { get { return _isRoleMethod; } }
...
//					MethodBase mb = new PartialMethodDefinitionInfo (this);
					...
					spec = new MethodSpec (kind, Parent.Definition, this, ReturnType, null, parameters, ModFlags,_isRoleMethod);
					if (MemberName.Arity > 0) {
						spec.IsGeneric = true;
            ...
            spec = new MethodSpec(kind, Parent.Definition, this, ReturnType, MethodBuilder, parameters, ModFlags, _isRoleMethod);
			if (MemberName.Arity > 0)
				spec.IsGeneric = true;
	...
	public class Method : MethodOrOperator, IGenericMethodDefinition
	{
		...
		public Method (DeclSpace parent, GenericMethod generic,
			...
			: base (parent, generic, return_type, (mod & (~Modifiers.ROLE)) & (~Modifiers.ENTRY),
                ...
                name, attrs, parameters, (mod & Modifiers.ROLE) != 0)
        {
		...
		protected Method (DeclSpace parent, FullNamedExpression return_type, Modifiers mod, Modifiers amod,
					MemberName name, ParametersCompiled parameters, Attributes attrs)
            : base(parent, null, return_type, (mod & (~Modifiers.ROLE)) & (~Modifiers.ENTRY), amod, name, attrs, parameters, (mod & Modifiers.ROLE) != 0)
		{
		}
        ...
        public override Modifiers ModFlags
        {
            get
            {
                return IsRoleMethod ? base.ModFlags | Modifiers.ROLE : base.ModFlags;
            }
            set
            {
                base.ModFlags = value;
	...
	public class Constructor : MethodCore, IMethodData {
		...
		public override bool Define ()
		{
			...
			spec = new MethodSpec (MemberKind.Constructor, Parent.Definition, this, Compiler.BuiltinTypes.Void, ConstructorBuilder, parameters, ModFlags, false);
...
//			else
	...
	public class Destructor : MethodOrOperator
	{
		...
		public Destructor (DeclSpace parent, Modifiers mod, ParametersCompiled parameters, Attributes attrs, Location l)
			: base (parent, null, null, mod, AllowedModifiers,
				new MemberName (MetadataName, l), attrs, parameters,false)
		{
	...
	public class Operator : MethodOrOperator {
		...
		public Operator (DeclSpace parent, OpType type, FullNamedExpression ret_type,
			...
			: base (parent, null, ret_type, mod_flags, AllowedModifiers,
				new MemberName (GetMetadataName (type), loc), attrs, parameters,false)
		{
			OperatorType = type;
			Block = block;
		}
