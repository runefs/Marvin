	...
	abstract public class PropertyBase : PropertyBasedMember {
		...
		public class GetMethod : PropertyMethod
		{
			...
			public override MethodBuilder Define (DeclSpace parent)
			{
				...
				Spec = new MethodSpec (MemberKind.Method, parent.PartialContainer.Definition, this, ReturnType, null, ParameterInfo, ModFlags,false);
	...
	public abstract class Event : PropertyBasedMember
	{
		public abstract class AEventAccessor : AbstractPropertyEventMethod
		{
			...
			public virtual MethodBuilder Define (DeclSpace parent)
			{
				...
				Spec = new MethodSpec (MemberKind.Method, parent.PartialContainer.Definition, this, ReturnType, mb, ParameterInfo, method.ModFlags,false);
