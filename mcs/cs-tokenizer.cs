...
namespace Mono.CSharp
{
	...
	public class Tokenizer : yyParser.yyInput
	{
		...
		static Tokenizer ()
		{
			...
			keywords = new KeywordEntry<int>[12][];
			
			//DCI
			AddKeyword ("entry",Token.ENTRY);
			AddKeyword ("interaction",Token.INTERACTION);
			AddKeyword ("role",Token.ROLE);
			AddKeyword ("contract",Token.CONTRACT);
