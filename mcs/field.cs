...
namespace Mono.CSharp
{
	...
	public class FieldSpec : MemberSpec, IInterfaceMemberSpec
	{
	    ...
	    public bool IsRole { get { return _isRole; } }
    ...
    public class RoleField : Field{
        ...
        public Interface Contract { get{
            var contractName = CSharpParser.GetCurrentRoleContractName(this.CurrentType.Name, Name);
            if (CSharpParser.RoleContracts.ContainsKey(contractName))
              return CSharpParser.RoleContracts[contractName];
            return null;
        } }
    }
	//
	...
	public class Field : FieldBase {
        ...
        {
            get{
                return IsRole ? base.ModFlags | Modifiers.ROLE : base.ModFlags;
            }
            set
            {
                base.ModFlags = value;
